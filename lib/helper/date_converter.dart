...
class DateConverter {
  ...
  static String dateTimeStringToMonthAndYear(String dateTime) {
    return DateFormat('dd MMM, yyyy . hh:mm aa').format(DateFormat('yyyy-MM-ddTHH:mm:ss').parse(dateTime));
  }
  ...
  static String supportDate(String dateTime) {
    DateTime localDate = DateFormat('yyyy-MM-ddTHH:mm:ss.SSS').parse(dateTime, true).toLocal();
    return DateFormat('dd MMM yyyy hh:mm a').format(localDate);
  }

  static String utcToLocalDAte(String utcDateString) {
    DateTime utcDate = DateFormat('yyyy-MM-ddTHH:mm:ss.SSSZ').parse(utcDateString, true);
  ...
  static String dateTimeForQuiz(String dateTime) {
  ...
  static String localToIsoString(DateTime dateTime) {
    return DateFormat('dd/MM/yyyy, hh:MM aa').format(dateTime.toLocal());
  }
  ...
  static String quotationDateAndTime(DateTime dateTime) {
