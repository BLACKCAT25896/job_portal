              ...
              if (widget.showToolbar)
                Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                      top: BorderSide(color: Theme.of(context).disabledColor, width: 0.5),
                      left: BorderSide(color: Theme.of(context).disabledColor, width: 0.5),
            ...
            child: SizedBox(
              ...
              child: HtmlEditor(
                ...
                htmlToolbarOptions: widget.showToolbar
                  ...
                  dropdownIconColor: Theme.of(context).disabledColor,
                  ...
                  defaultToolbarButtons: [
                    ...
                    const FontButtons(subscript: false, superscript: false, clearAll: true),
