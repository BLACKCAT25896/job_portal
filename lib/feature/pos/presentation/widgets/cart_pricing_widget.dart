  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        ...
        Text(title!, style: textRegular.copyWith(color: isTotal? Theme.of(context).textTheme.headlineLarge?.color:
        ...
        Text(amount!, style: textRegular.copyWith(color: isTotal? Theme.of(context).textTheme.headlineLarge?.color:
        Theme.of(context).hintColor,fontWeight: isTotal? FontWeight.w700: FontWeight.w500,
            fontSize: isTotal? Dimensions.fontSizeLarge: Dimensions.fontSizeDefault),),
