...
class _RazorPayPaymentGatewayCardItemState extends State<RazorPayPaymentGatewayCardItem> {
  ...
  @override
  void initState() {
    final paymentInfo = Get.find<PaymentMethodController>().razorPayPaymentGatewayItem?.credentials;
    apiKeyController.text = paymentInfo?.apiKey ?? "";
    apiSecretController.text = paymentInfo?.apiSecret ?? "";
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PaymentMethodController>(builder: (saasPaymentGatewayController) {
        PaymentMethodItem? paymentGatewayItem = saasPaymentGatewayController.razorPayPaymentGatewayItem;
        ...
        CustomContainer(borderRadius: Dimensions.radiusSmall, showShadow: false,
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: Dimensions.paddingSizeExtraSmall, children: [
              ...
              const CustomImage( height: 100, image: Images.razorPay, isLocalAsset: true,),
              ...
              CustomTextField(title: "api_secret".tr,
                ...
                hintText: paymentGatewayItem.credentials?.apiSecret,),
