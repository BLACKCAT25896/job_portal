...
class DepositCategoryDetailsHeaderSection extends StatelessWidget {
  const DepositCategoryDetailsHeaderSection({super.key});
            ...
            child: CustomContainer(borderRadius: 5, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('total_deposit'.tr, style: textRegular.copyWith()),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    Text(PriceConverter.convertPrice(context, depositCategoryDetailsModel?.data?.depositsSumAmount??0), style: textSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  ],
                )),
