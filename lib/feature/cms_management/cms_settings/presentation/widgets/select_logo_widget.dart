        ...
        child: Column(spacing: Dimensions.paddingSizeDefault,children: [
          Row(spacing: Dimensions.paddingSizeDefault, children: [
            Expanded(child: LogoItem(
              ...
              imageUrl: model != null?"${AppConstants.imageBaseUrl}/image_settings/${model.data?.headerLogoLightTheme}":"",
            ...
            Expanded(child: LogoItem(
              ...
              imageUrl: model != null? "${AppConstants.imageBaseUrl}/image_settings/${model.data?.headerLogoDarkTheme}":"",
              loading: controller.loading,
          ...
          Row(spacing: Dimensions.paddingSizeDefault, children: [
            Expanded(child: LogoItem(
              ...
              imageUrl: model != null? "${AppConstants.imageBaseUrl}/image_settings/${model.data?.footerLogoLightTheme}":"",
              loading: controller.loading,
            ...
            Expanded(child: LogoItem(
              ...
              imageUrl: model != null? "${AppConstants.imageBaseUrl}/image_settings/${model.data?.footerLogoDarkTheme}":"",
              loading: controller.loading,
