...
class PublicPostListWidget extends StatefulWidget {
  final ScrollController scrollController;
  final bool fromFilter;

  const PublicPostListWidget({super.key, required this.scrollController, this.fromFilter = false});

  @override
  State<PublicPostListWidget> createState() => _PublicPostListWidgetState();
}

class _PublicPostListWidgetState extends State<PublicPostListWidget> {
          ...
          builder: (controller) {
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                PaginatedListWidget(landing: true,limit: 50,
                  ...
                  onPaginate: (int? offset) async => await controller.getLandingPostList(offset??1),
                        ...
                        return CustomContainer(borderRadius: 5, showShadow: false,
                            child: Row(spacing: Dimensions.paddingSizeExtraSmall,
                              children: [
                                ...
                                Expanded(child: Text(item?.title??'', style: textRegular)),
                              ],
                            ));
                       }),
                ),
