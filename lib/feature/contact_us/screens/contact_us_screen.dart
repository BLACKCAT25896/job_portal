...
class _ContactUsScreenState extends State<ContactUsScreen> {
  ...
  Widget build(BuildContext context) {
    final bool sDesktop = ResponsiveHelper.isDesktop(context);
    return BaseLayout(scrollController: scrollController,
      child: Center(child: SizedBox(width: Dimensions.webMaxWidth,
          child: GetBuilder<LandingPageController>(builder: (controller) {
            ...
            return sDesktop ? Padding(
              padding: const EdgeInsets.symmetric(vertical: 50),
              child: Row(spacing: Dimensions.paddingSizeOverLarge,
            ...
            ): Column(spacing: Dimensions.paddingSizeOverLarge, children: [
                const _ContactInfo(),
                const _ContactForm(),
              ],
            );
...
class _ContactInfo extends StatelessWidget {
      ...
      builder: (settingController) {
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text("Get in touch with us for any questions, support, or feedback. Submit the form below and we’ll respond shortly.",
            ...
            const SizedBox(height: 16),
            _contactItem(Icons.email, "email_address".tr, info?.companyEmail??''),
          ],
        );
      }
    );
  ...
  Widget _contactItem(IconData icon, String title, String detail) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start,
      children: [CircleAvatar(radius: 18,
...
class _ContactFormState extends State<_ContactForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomContainer(showShadow: false, borderRadius: Dimensions.paddingSizeSmall,
      child: Padding(padding: const EdgeInsets.all(24.0),
        child: Column(crossAxisAlignment: CrossAxisAlignment.end,
          spacing: Dimensions.paddingSizeSmall, children: [
          CustomTextField(title: "name".tr,
              controller: nameController,hintText: "enter_name".tr),

          CustomTextField(title: "email".tr,
              controller: emailController, hintText: "enter_email".tr),
