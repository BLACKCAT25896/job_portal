...
import 'package:mighty_job/feature/sms/phone_book/presentation/widgets/phone_book_item_widget.dart';
    ...
    return GetBuilder<PhoneBookController>(
      ...
      builder: (controller) {
        ...
        return GenericListSection<PhoneBookItem>(
          ...
          onAddNewTap: () => Get.dialog(const CreateNewPhoneBookScreen()),
