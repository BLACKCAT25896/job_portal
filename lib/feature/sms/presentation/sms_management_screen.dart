...
class _SmsManagementScreenState extends State<SmsManagementScreen> {
  List<MainMenuModel> studentInformationItems = [
    MainMenuModel(icon: Images.logo, title: 'sms_template', widget:  const SmsTemplateScreen()),
    MainMenuModel(icon: Images.logo, title: 'phone_book_category', widget:  const PhoneBookCategoryScreen()),
    MainMenuModel(icon: Images.logo, title: 'phone_book', widget:  const PhoneBookScreen()),
    MainMenuModel(icon: Images.logo, title: 'sms_sent', widget:  const PurchaseSmsScreen()),
    MainMenuModel(icon: Images.logo, title: 'purchase_sms', widget:  const PurchaseSmsScreen()),
    MainMenuModel(icon: Images.logo, title: 'sms_report', widget:  const PurchaseSmsScreen()),
  ];
  @override
