...
class CandidateAccountSettingScreen extends StatefulWidget {
  const CandidateAccountSettingScreen({super.key});

  @override
  State<CandidateAccountSettingScreen> createState() => _CandidateAccountSettingScreenState();
}

class _CandidateAccountSettingScreenState extends State<CandidateAccountSettingScreen> {
